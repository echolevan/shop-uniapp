        ...
        <view class="user-menus" style="margin-top: 20rpx" v-if="my_menus_status">
          ...
          <view :class="{ 'list-box': my_menus_status == 1, 'column-box': my_menus_status == 2 }">
            ...
            <view class="item">
              <contact-button
                  size="30"
                  tnt-inst-id="CZi_bRyM" scene="SCE01372094">
              </contact-button>
              <text class="name" style="margin-top: 5px">{{ $t('联系客服') }}</text>
            </view>
            ...
            <!--							<text class="name">{{ $t('联系客服') }}111</text>-->
            <!--							<text class="iconfont icon-jiantou" v-if="my_menus_status == 2"></text>-->
            <!--						</button>-->
            <!-- #endif -->
            <!-- #ifdef APP-PLUS -->
